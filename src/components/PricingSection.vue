                ...
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                        <div class="circle2">
                          <v-img src="~@/assets/img/fact.png"></v-img>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="text-uppercase grey--text">
                      Several free affermations categories
                    </div>
                  ...
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                        <div class="circle2">
                          <v-img
                            src="~@/assets/img/facts.png"
                          ></v-img>
                        </div>
                      </div>
                    </div>
                    <div
                      class="grey--text text--darken-1 text-uppercase text-h5 my-2"
                    >
                      Premium 1 month
                    </div>
                    <v-divider class="mt-6 mb-3" />
                    <div class="text-uppercase grey--text text--darken-1">
                      All basic options
                    </div>
                    <v-divider class="my-3" />
                    <div class="text-uppercase grey--text text--darken-1">
                      All facts categories
                    </div>
                    <v-divider class="my-3" />
                    <div class="text-uppercase grey--text text--darken-1">
                      No ads
                    ...
                    <v-divider class="my-3" />
                    <div class="text-h4 mt-6 blue--text">5.64$/month</div>
                  </v-card-text>
                  <v-divider
                    style="margin-right: -23px"
                    vertical
              ...
              <v-col class="col-12 col-sm-4 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <v-divider class="my-3" />
                    <div class="text-h4 mt-6 blue--text">22.5$/year</div>
                  </v-card-text>
                </div>
              </v-col>
            </v-row>
